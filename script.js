...
function showWheelResult(percentage, segmentIndex) {
    ...
    resultModal.innerHTML = `
        <div class="modal-content" style="max-width: 500px; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
            <div class="modal-header" style="background: rgba(255,255,255,0.1); border-radius: 20px 20px 0 0;">
                <h2 style="color: #ffd700; font-size: 28px; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); animation: pulse 2s ease-in-out infinite;">🎰 Wheel Result! 🎰</h2>
                <button class="close-btn" onclick="this.closest('.modal-overlay').remove()" style="background: rgba(255,255,255,0.2); border: 2px solid #ffd700;">
            ...
            <div class="modal-body" style="padding: 30px;">
                ...
                <div style="font-size: 64px; font-weight: bold; color: #ffd700; margin-bottom: 20px; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); animation: glow 2s ease-in-out infinite;">
                    ${percentage}%
                </div>
                <p style="font-size: 20px; margin-bottom: 20px; color: #fff; text-shadow: 1px 1px 2px rgba(0,0,0,0.5); font-weight: 500;">
                    If your order has no issues, you get <strong style="color: #2ed573;">${percentage}% discount</strong> on your order.
                </p>
                <p style="font-size: 20px; margin-bottom: 30px; color: #ff6b6b; text-shadow: 1px 1px 2px rgba(0,0,0,0.5); font-weight: 500;">
                    If there are any issues with your order, you'll pay <strong>${percentage}% premium penalty</strong>.
                </p>
                <p style="color: #ffd700; margin-bottom: 30px; font-size: 18px; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">
                    The final amount will be determined based on your order quality!
                </p>
            </div>
            <div class="modal-footer" style="background: rgba(255,255,255,0.1); border-radius: 0 0 20px 20px; padding: 20px;">
                <button class="place-order-btn" onclick="this.closest('.modal-overlay').remove()" style="background: linear-gradient(135deg, #ffd700, #ffed4e); color: #2c3e50; font-weight: bold; font-size: 18px; padding: 15px 30px; border-radius: 25px; box-shadow: 0 4px 15px rgba(255,215,0,0.4);">
                    🎊 Continue 🎊
                </button>
            </div>
        </div>
    ...
    style.textContent = `
        ...
        @keyframes glow {
            ...
            50% { text-shadow: 2px 2px 4px rgba(0,0,0,0.5), 0 0 30px rgba(255,215,0,0.8); }
        }
    `;
...
function createConfetti() {
    const colors = ['#ff6b6b', '#4ecdc4', '#45b7d1', '#96ceb4', '#feca57', '#ffd700'];
